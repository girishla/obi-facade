...
public class getPermissionsResult extends Vector< Integer> implements KvmSerializable
{
    
    public getPermissionsResult(){}
    
    public getPermissionsResult(java.lang.Object inObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        if (inObj == null)
            return;
