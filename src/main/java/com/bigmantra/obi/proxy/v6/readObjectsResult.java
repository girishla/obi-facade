...
public class readObjectsResult extends Vector< CatalogObject> implements KvmSerializable
{
    
    public readObjectsResult(){}
    
    public readObjectsResult(java.lang.Object inObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        if (inObj == null)
            return;
