...
public class getAccountsResult extends Vector< Account> implements KvmSerializable
{
    
    public getAccountsResult(){}
    
    public getAccountsResult(java.lang.Object inObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        if (inObj == null)
            return;
