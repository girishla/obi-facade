...
public class ConditionService
{
    ...
    String url="http://pelobidev2.projected.ltd.uk:9704/analytics/saw.dll?SoapImpl=conditionService";
    ...
    public ConditionService(String url)
    {
        this.url = url;
    }

    public ConditionService(String url,int timeOut)
    {
        this.url = url;
    ...
    public Boolean evaluateCondition(final evaluateCondition evaluateCondition ) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new IWcfMethod()
        {
            ...
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
              ExtendedSoapSerializationEnvelope __envelope = createEnvelope();
                __envelope.addMapping("urn://oracle.bi.webservices/v6","evaluateCondition",new evaluateCondition().getClass());
                __envelope.setOutputSoapObject(evaluateCondition);
                return __envelope;
            }
            ...
            public java.lang.Object ProcessResult(ExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
                ...
                java.lang.Object obj = __soap.getProperty("conditionIsTrue");
        ...
        },"#evaluateCondition",__profile);
    }
    
    public Boolean evaluateInlineCondition(final evaluateInlineCondition evaluateInlineCondition ) throws java.lang.Exception
    {
        com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile __profile = new com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile();
        return (Boolean)execute(new IWcfMethod()
        {
            ...
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
              ExtendedSoapSerializationEnvelope __envelope = createEnvelope();
                __envelope.addMapping("urn://oracle.bi.webservices/v6","evaluateInlineCondition",new evaluateInlineCondition().getClass());
                __envelope.setOutputSoapObject(evaluateInlineCondition);
                return __envelope;
            }
        ...
        },"#evaluateInlineCondition",__profile);
    }
    
    public getConditionCustomizableReportElementsResult getConditionCustomizableReportElements(final String path,final String sessionID ) throws java.lang.Exception
    {
        com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile __profile = new com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile();
        return (getConditionCustomizableReportElementsResult)execute(new IWcfMethod()
        {
            @Override
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
              ExtendedSoapSerializationEnvelope __envelope = createEnvelope();
                SoapObject __soapReq = new SoapObject("urn://oracle.bi.webservices/v6", "getConditionCustomizableReportElements");
            ...
            @Override
            public java.lang.Object ProcessResult(ExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
                return (getConditionCustomizableReportElementsResult)getResult(getConditionCustomizableReportElementsResult.class,__result,"getConditionCustomizableReportElementsResult",__envelope);
            }
        },"#getConditionCustomizableReportElements",__profile);
    }
