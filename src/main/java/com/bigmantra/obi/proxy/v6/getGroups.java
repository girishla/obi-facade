...
public class getGroups extends AttributeContainer implements KvmSerializable
{
    ...
    public getGroups (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex>=0 && propertyIndex < 0+this.member.size())
        {
            return this.member.get(propertyIndex-(0));
        }
        if(propertyIndex==0+this.member.size())
        {
            return this.expandGroups!=null?this.expandGroups:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==1+this.member.size())
        {
