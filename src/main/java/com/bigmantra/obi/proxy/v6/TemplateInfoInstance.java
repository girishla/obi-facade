...
public class TemplateInfoInstance extends AttributeContainer implements KvmSerializable
{
    ...
    public TemplateInfoInstance (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("instanceName"))
                {
                    if(obj!=null)
                    {
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex>=1 && propertyIndex < 1+this.nameValues.size())
        {
            return this.nameValues.get(propertyIndex-(1));
        }
        return null;
    }
