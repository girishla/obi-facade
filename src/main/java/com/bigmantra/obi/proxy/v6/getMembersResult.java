...
public class getMembersResult extends Vector< Account> implements KvmSerializable
{
    
    public getMembersResult(){}
    
    public getMembersResult(java.lang.Object inObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        if (inObj == null)
            return;
