...
public class keepAlive extends Vector< String> implements KvmSerializable
{
    
    public keepAlive(){}
    
    public keepAlive(java.lang.Object inObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        if (inObj == null)
            return;
