...
public class copyItem2 extends AttributeContainer implements KvmSerializable
{
    ...
    public copyItem2 (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("permissions"))
                {
                    if(obj!=null)
                    {
                        ...
                        if (obj.getClass().equals(SoapPrimitive.class))
                        {
                            ...
                            if(j.toString()!=null)
                            {
                                this.permissions = new Boolean(j.toString());
                            }
                        }
                        else if (obj instanceof Boolean){
                            this.permissions = (Boolean)obj;
                        }
                    }
                    continue;
                }
                if (info.name.equals("timestamps"))
                {
                    if(obj!=null)
                    {
                        ...
                        if (obj.getClass().equals(SoapPrimitive.class))
                        {
                            ...
                            if(j.toString()!=null)
                            {
                                this.timestamps = new Boolean(j.toString());
                            }
                        }
                        else if (obj instanceof Boolean){
                            this.timestamps = (Boolean)obj;
                        }
                    }
                    continue;
                }
                if (info.name.equals("useMtom"))
                {
                    if(obj!=null)
                    {
                        ...
                        if (obj.getClass().equals(SoapPrimitive.class))
                        {
                            ...
                            if(j.toString()!=null)
                            {
                                this.useMtom = new Boolean(j.toString());
                            }
                        }
                        else if (obj instanceof Boolean){
                            this.useMtom = (Boolean)obj;
                        }
                    }
                    continue;
                }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==4+this.path.size())
        {
