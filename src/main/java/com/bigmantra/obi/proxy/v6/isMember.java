...
public class isMember extends AttributeContainer implements KvmSerializable
{
    ...
    public isMember (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==1+this.group.size()+this.member.size())
        {
    ...
    public int getPropertyCount() {
        return 2+group.size()+member.size();
    }
